...
const transporter = nodemailer.createTransport({
  service: 'gmail',
  auth: {
    user: 'tulsi1457.be21@chitkara.edu.in',
    pass: 'vtfe gaaf ajjq fmgy',
  },
});
const sendVerificationEmail =(email, verificationToken) => {
  ...
  const mailOptions = {
    from: 'khannatushar027@gmail.com',
    to: email,
...
const authController = {
 ...
 register : async (req, res) => {
  try {
    ...
    const isAdmin = username.toLowerCase() === 'tushar' && email === 'khannatushar027@gmail.com';
